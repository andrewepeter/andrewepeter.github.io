    ...
    <div id="Projects" className="max-w-7xl mx-auto py-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white rounded-lg shadow-lg p-6">
                    <h2 className="text-xl font-bold mb-4">jobnavigAItor.com</h2>
                    <p className="mt-2 text-gray-700">
                    Developed a comprehensive AI-powered job search application that enhances user experience by tracking job applications, generating personalized cover letters, preparing interview questions, crafting post-interview thank you emails, and customizing resumes to match job postings. Utilized OpenAI APIs for natural language processing and generation, with Flask, PostgreSQL, and React as the core technologies.</p>
                    <a href="https://jobnavigaitor.com" target="_blank" rel="noopener noreferrer" className="mt-4 inline-block bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded transition duration-300">View Project</a>
                </div>
